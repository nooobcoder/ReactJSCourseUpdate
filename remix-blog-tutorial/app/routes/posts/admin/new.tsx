...
const action: ActionFunction = async ({ request }) => {
  ...
  /* // TODO: Remove the fake delay
  // !WARNING: This is a fake delay to simulate a server request
...
const NewPost = () => {
  ...
  const { submission: isCreating } = useTransition();
    ...
    <Form method="post">
      <p>
        <label>
          ...
          <input type="text" name="title" className={styles.inputClassName} />
        </label>
      </p>
      <p>
        <label>
          ...
          <input type="text" name="slug" className={styles.inputClassName} />
        </label>
      </p>
      <p>
        ...
        <textarea
          ...
          rows={20}
          name="markdown"
          className={`${styles.inputClassName} font-mono`}
        />
      </p>
