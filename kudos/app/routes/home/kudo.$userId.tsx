...
import { createKudo } from "~/utils/kudos.sever";
			...
			<form method="post">
				...
				<div className="flex flex-col md:flex-row gap-y-2 md:gap-y-0">
					...
					<div className="flex-1 flex flex-col gap-y-4">
						<textarea
							name="message"
							className="w-full rounded-xl h-40 p-4 focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-4 sm:text-sm focus:bg-white text-emerald-600 bg-gray-300"
